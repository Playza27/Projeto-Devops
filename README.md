...
Serviços e Funções:
 * backend: Node.js (Express) na porta 3000. É a API REST com lógica de negócios e CORS configurado.
 * frontend: Nginx + HTML/JS na porta 8080. É o Servidor Web que consome a API.
 * zabbix-db-mysql: MariaDB 10.5 (Porta Interna). É o Banco de dados para o Zabbix Server.
...
Para acessar os componentes do projeto em seu navegador:
 * Aplicação Web (Frontend): http://localhost:8080
